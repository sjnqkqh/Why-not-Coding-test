...
(
    hiring_post_id                                BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
(
    ...
    CONSTRAINT fk_post_image_to_post FOREIGN KEY (post_id) REFERENCES TB_HIRING_POST (hiring_post_id)
);
