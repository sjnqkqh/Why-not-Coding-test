package com.challenge.self.api;
...
import com.challenge.self.config.EnableMockMvcUTF8;
import com.challenge.self.config.RestDocConfiguration;
import com.challenge.self.entity.User;
import com.challenge.self.dto.auth.req.CheckPhoneAuthReqDto;
...
import com.challenge.self.dto.auth.resp.CheckPhoneAuthRespDto;
